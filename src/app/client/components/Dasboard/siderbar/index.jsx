...
export default function UserPanel() {
  return (
    <>
      <ToastContainer />
      <div class="bg-gray-100 dark:bg-gray-900 flex-1">
        <nav class="w-32 flex flex-col items-center bg-white dark:bg-gray-800 py-4 fixed h-screen">
          <div>
            <svg
          ...
          <ul class="mt-2 text-gray-700 dark:text-gray-400 capitalize">
            ...
            <li class="mt-3 p-2 text-blue-600 dark:text-blue-300 rounded-lg">
              <a href="/client" class=" flex flex-col items-center">
            ...
            <li
              class="mt-3 p-2 hover:text-blue-600 dark-hover:text-blue-300
				rounded-lg">
              <a href="/client/messages" class=" flex flex-col items-center">
                <svg class="fill-current h-5 w-5" viewBox="0 0 24 24">
                  <path
            ...
            <li
              class="mt-3 p-2 hover:text-blue-600 dark-hover:text-blue-300
				rounded-lg">
              <a href="/client/friends" class=" flex flex-col items-center">
                <svg class="fill-current h-5 w-5" viewBox="0 0 24 24">
                  <path
